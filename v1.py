...
my_channel_id = [-1001538842585] #айди канала приватки (-1001538842585 это тестовый)
channels_to = [-1001947945341] #наш канал (PRIVATE CALLS)
    ...
    if event.message:
        for channel_id in channels_to:
            ...
            if isinstance(event.message.media, MessageMediaPhoto):
                media_file = event.message.media.photo

                for channel_id in channels_to:
                    await client.send_file(channel_id, media_file)
